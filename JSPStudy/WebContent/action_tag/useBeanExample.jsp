...
<jsp:setProperty name="account" property="accountNum" value="1002-654-932900"/>
<jsp:setProperty name="account" property="accountOwner" value="박시원"/>
<jsp:setProperty name="account" property="passwd" value="1002"/>
<jsp:setProperty name="account" property="restMoney" value="1000000"/>
<%--
<jsp:forward page="/action_tag/useBeanExample2.jsp"/>
 --%>
<!DOCTYPE html>
<html>
<head>
